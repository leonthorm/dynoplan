...
BOOST_AUTO_TEST_CASE(t_multi_robot_swap1_quad3d) {
  bool sum_robots_cost = 1;
    std::string env_file = DYNOBENCH_BASE "envs/multirobot/example/swap1_quad3d.yaml";
    std::string initial_guess_file = DYNOBENCH_BASE "envs/multirobot/results/swap1_quad3d.yaml";

    // std::string env_file =  "../../../dynoplan/dynobench/envs/multirobot/example/swap1_quad3d.yaml";
    // std::string initial_guess_file =  "../../../dynoplan/dynobench/envs/multirobot/results/swap1_quad3d.yaml";

// "dynoplan/test/optimization/test_optimization_multirobot.cpp"
// "example/swap1_quad3d.yaml"
    Problem problem(env_file);
    MultiRobotTrajectory init_guess_multi_robot;
    init_guess_multi_robot.read_from_yaml(initial_guess_file.c_str());
    std::vector<int> goal_times(init_guess_multi_robot.trajectories.size());
    ...
    options_trajopt.max_iter = 10000000;
    ...
    MultiRobotTrajectory multi_out = from_joint_to_indiv_trajectory(
      sol, init_guess_multi_robot.get_nxs(), init_guess_multi_robot.get_nus(),
      index_time_goals);
    multi_out.to_yaml_format("/tmp/test_multi_swap1_quad3d.yaml");
}

BOOST_AUTO_TEST_CASE(t_multi_robot_swap2_quad3d) {
  bool sum_robots_cost = 1;
    std::string env_file = DYNOBENCH_BASE "envs/multirobot/example/swap2_quad3d.yaml";
    std::string initial_guess_file = DYNOBENCH_BASE "envs/multirobot/results/swap2_quad3d.yaml";
